...
from usluga_payment.serializers import MakePaymentSerializer, PodiezdSerializer
...
class MakePayment(APIView):
    def post(self, request, *args, **kwargs):
        ...
        return Response(
            {
                "baip_system_data": result,
                "data": PodiezdSerializer(instance=serializer.instance).data,
            },
            status=200,
        )
