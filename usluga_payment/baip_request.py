...
def prepare_baip_account_data(transaction, operator, customer, action, **kwargs):
  ...
  <general>
    ...
    <session_start>{operator.created}</session_start>
  ...
  <products>
    <item>
      ...
      <description>{{NL}}{customer.name}{{NL}}Номер транзакции:{transaction.transaction_number}</description >
...
#   <general>
#     <partner_transaction_id>1</partner_transaction_id>
#     <kiosk_id>001001</kiosk_id>
#     <partner_contract_id>456</partner_contract_id>
#     <host_ip>192.168.3.190</host_ip>
#     <session_start>2022-09-30</session_start>
#     <cashregister_id>720005</cashregister_id>
